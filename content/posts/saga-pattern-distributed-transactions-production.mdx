...
description: "Two-phase commit doesn't scale. Here's how I handle consistency across microservices in production using the Saga pattern — with real failure modes, idempotency requirements, and SQS-backed choreography."
date: "2026-04-20"
